...
export default {
    ...
    created() {
      this.mealname = this.mealToEdit.name;
      this.selectedCategory = this.mealToEdit.category;
    },
    ...
    methods: {
      ...
      save() {
        const data = {};
        data["id"] = this.mealToEdit.id;
        data["name"] = this.mealname;
        data["category"] = this.selectedCategory;
        this.selectedCategory = '';
        this.mealname = '';
        this.dialog = false;
        this.$emit("onEditMeal", data);
      },
    },
}
</script>